...
Future<Uint8List> generateInvoiceBedone(
  PdfPageFormat pageFormat, List<ProductInvoBedoneh> products, OrderTwo us,
  ...
  final invoice = Invoice(
    ...
    paymentInfo: ' نشانی کامل:تهران خیابان ولیعصر خیابان بزرگمهر' +
        '\n' +
        '  نبش خیابان فریمان پلاک 27 ' +
        '\n' +
        ' شماره تلفن - نمابر:  910118550-021 / 09190694410 ' +
        '\n' ,
...
class Invoice {
  ...
  final List<ProductInvoBedoneh> products;
  ...
  PdfPageFormat pageFormat, OrderTwo us,) async {
  ...
  pw.Widget _contentHeader(
      pw.Context context, pw.Font font, OrderTwo us) {
    return pw.Row(
      crossAxisAlignment: pw.CrossAxisAlignment.end,
      children: [
        // pw.Expanded(
  ...
  pw.Widget _contentTable(pw.Context context, pw.Font font, NumberFormat formatter) {
    const tableHeaders = ['مبلغ کل', 'قیمت', 'تعداد', 'مشخصات محصول', 'ردیف'];
    //['4مشخصات محصول', '3مبلغ کل', '2قیمت', '1تعداد', '0ردیف'];
    return pw.TableHelper.fromTextArray(
      ...
      headerHeight: 25,
      cellHeight: 40,
      //['0مشخصات محصول', '1مبلغ کل', '2قیمت', '3تعداد', '4ردیف'];
      cellAlignments: {
...
class ProductInvoBedoneh {
  const ProductInvoBedoneh(
    this.sku,
    this.productName,
    this.price,
    this.quantity,
