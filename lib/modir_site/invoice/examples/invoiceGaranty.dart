...
Future<Uint8List> generateInvoiceGaranty(
  PdfPageFormat pageFormat,
  List<ProductInvoGaranty> products,
  OrderTwo us,
) async {
...
class Invoice {
  ...
  final List<ProductInvoGaranty> products;
...
class ProductInvoGaranty {
  const ProductInvoGaranty(
      this.sku,
      this.productName,
      this.price,
      this.quantity,
